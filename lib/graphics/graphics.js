...
import { light_spot, resetLightIndexes, setNrLights } from "./light.js";
...
function main() {
    ...
    // ))
    lights.push(new light_spot(vec4.fromValues(0.1, 0.1, 0.1, 1.0), vec4.fromValues(0.2, 0.2, 0.8, 1.0), vec4.fromValues(0.5, 0.5, 0.5, 1.0), vec3.fromValues(0, 500, 0), vec3.fromValues(0, -1, 0), 50));
