...
export class material {
    constructor(gl, matJson, modelName) {
    ...
    use(gl, program) {
        ...
        this.texNum = 0;
        gl.uniform3fv(gl.getUniformLocation(program, "color_diffuse"), this.color_diffuse);
        gl.uniform3fv(gl.getUniformLocation(program, "color_specular"), this.color_specular);
        //console.log("color_ambient: " + this.color_ambient[0]+"," + this.color_ambient[1]+"," + this.color_ambient[2])
        gl.uniform3fv(gl.getUniformLocation(program, "color_ambient"), this.color_ambient);
